    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-slate-500">
          Upload your resume and connect your GitHub profile to proceed
        </p>
      </div>
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-2 bg-white text-slate-400">Or connect profiles</span>
        </div>
      </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-slate-500">
                {githubConnected ? 'Connected' : 'Import your repositories'}
              </p>
            </div>
            {githubConnected && (
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-slate-500">
                {linkedInConnected ? 'Connected' : 'Sync your experience'}
              </p>
            </div>
            {linkedInConnected && (
              <div className="w-8 h-8 bg-emerald-500 rounded-full flex items-center justify-center">
      ...
      <div className="flex items-start gap-3 p-4 bg-blue-50 border border-blue-100 rounded-xl">
        ...
        <p className="text-sm text-blue-700">
          Connecting your GitHub profile is mandatory to analyze your skills and suggest the best learning paths.
          Manual path selection is disabled for this session.
        </p>
      </div>
    </div>
  );
