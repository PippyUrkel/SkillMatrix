...
export const ProfileDropdown: React.FC<ProfileDropdownProps> = ({ open, onClose, onNavigate }) => {
    ...
    return (
        <div
            ref={ref}
            className="absolute right-0 top-full mt-2 w-72 bg-white border border-slate-200 rounded-2xl shadow-2xl z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200"
        >
            {/* User Info */}
            ...
            <div className="p-2">
                <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-colors"
                >
