  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        {/* 🔥 Streak Counter */}
        <button className="flex items-center gap-1.5 px-3 py-1.5 bg-orange-50 border border-orange-200 rounded-xl hover:bg-orange-100 transition-colors group">
        ...
        <div className="relative">
          <button
            ...
            className="w-9 h-9 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center hover:ring-2 hover:ring-emerald-200 transition-all cursor-pointer"
          >
